...
func (j JwtRepository) Find(ctx context.Context, userId int, refreshToken string) (*models.Token, error) {
...
func (j JwtRepository) Revoke(ctx context.Context, userId int, refreshToken string) error {
